...
class Student:
    def __init__(self, studentid, firstname, surname, score1, score2, score3):
    ...
    def display(self):
        print(f"{self.studentid:<10} {self.firstname:<10} {self.surname:<10} {self.score1:<7} {self.score2:<7} {self.score3:<7} {self.total:<7}")

students = []
## Can split up the code below into more functions
...
for row in rows:
    ...
    if not fields[5].isdigit() or int(fields[5]) < 0 or int(fields[5]) > 20:
        ...
        students.append(Student(fields[0], fields[1], fields[2], fields[3], fields[4], fields[5]))
...
for student in students:
    if student.total > highest_score:
        ...
        highest_student = f'{student.firstname} {student.surname}'
